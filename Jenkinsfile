...
def deployApplications = ['analytics-dashboard', 'bouncer', 'checkmate', 'h', 'h-periodic', 'h-websocket', 'legacyvia', 'lms', 'lms-via', 'lms-viahtml', 'metabase', 'via', 'via3', 'viahtml'].join('\n')
